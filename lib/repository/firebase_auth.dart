...
class FireBaseAuth {
  ...
  Future resetPassword(String email) async {
    try {
      ...
      throw MessageException('Данная почта не зарегестрированна');
    }
  }
    ...
    try {
      ...
      if (auth.user != null) {
        result = await FirebaseFirestore.instance
            ...
            .doc(auth.user!.uid)
            .get()
            .then((DocumentSnapshot documentScnapshot) {
          return documentScnapshot.exists;
        });
      }
      return result;
    ...
    try {
      await _auth.verifyPhoneNumber(
          ...
          verificationFailed: (FirebaseAuthException error) {
            print('${error.message}');
            throw MessageException('Данный номер телефона не зарегестрирован');
          },
          codeSent: (String verifficationId, [int? forceResendingToken]) {
            func!(verifficationId);
          },
